...
```mermaid
flowchart LR
    subgraph Revenue [Nguồn Doanh Thu Chính]
        R1[1. Gói Phôi Thẻ NFC Kim Loại Khắc Laser]
        R2[2. Thuê Bao SaaS Quản Trị Hiệp Hội / CLB]
        R3[3. Gói Phần Mềm Trạm Check-in Sự Kiện MICE]
        R4[4. Dịch Vụ AI B2B Matchmaking Doanh Nghiệp]
    end
    subgraph Market [Thị Trường Mục Tiêu]
        M1[Các Hiệp hội Doanh nghiệp tại Khánh Hòa & Nam Trung Bộ]
        M2[Trung tâm Tổ chức Hội nghị / Khách sạn MICE Nha Trang]
        M3[Cộng đồng Doanh nhân, Chuyên gia, Startup ĐMST]
    end
    Revenue --> Market
```
