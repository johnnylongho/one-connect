  ...
  return (
    <div className="space-y-6 w-full pb-16">
      ...
      <PageHeader
        ...
        title="Trạm Check-in Thực Tế"
        description={`${activeEvent?.name || 'Diễn Đàn Kết Nối Doanh Nghiệp 2026'} — Điểm danh đại biểu siêu tốc <1s qua NFC & QR Code`}
        icon={Zap}
        badge="LIVE TERMINAL <1s"
        ...
        actions={
          <div className="flex flex-wrap items-center gap-2 w-full sm:w-auto justify-between sm:justify-end">
            ...
            <div className="flex flex-col items-end text-xs pl-2 border-l border-slate-100">
        ...
        {lastCheckInResult && (
          ...
          >
            ...
            {lastCheckInResult.identity && (
              <div className="p-4 rounded-2xl bg-white border border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-4 text-left max-w-md mx-auto shadow-sm">
                <div className="flex items-center gap-3 w-full sm:w-auto">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-[11px] text-slate-500 flex items-center gap-1 mt-0.5 truncate">
                      ...
                      <span className="truncate">{lastCheckInResult.identity.companyName || lastCheckInResult.identity.businesses?.[0]?.businessName || 'Doanh nghiệp Hội viên'}</span>
                    </p>
                  </div>
                </div>
