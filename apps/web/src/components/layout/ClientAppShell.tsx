...
export function ClientAppShell({ children }: { children: React.ReactNode }) {
  ...
  const hasClientAuthCookie =
    typeof document !== 'undefined' &&
    (document.cookie.includes('one_connect_auth_session=') || document.cookie.includes('sb-access-token='));

  if (!isStandalonePage && (!isHydrated || (!state.currentIdentityId && !hasClientAuthCookie))) {
    return (
      <div className="min-h-screen bg-[#070A12] text-slate-100 font-sans antialiased flex flex-col items-center justify-center p-4">
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-slate-900 font-sans antialiased selection:bg-blue-600 selection:text-white overflow-x-hidden">
      <div className="min-h-screen flex flex-col bg-[#F8FAFC] w-full overflow-x-hidden">
            ...
            {isJohnnySuperAdmin ? (
              <div className="relative">
                ...
                >
                  ...
                  <strong className="text-blue-950" suppressHydrationWarning>
                    {effectiveRole}
                  </strong>
        ...
        <div className="flex-1 flex w-full min-h-[calc(100vh-3.5rem)]">
                ...
                <>
                  <div className="flex items-center gap-2 min-w-0">
                    ...
                    <div className="min-w-0 flex-1 pr-1">
                      <p className="font-bold text-slate-900 text-xs truncate" suppressHydrationWarning>
                        {currentUserName}
                      </p>
                      <p className="text-[9.5px] text-blue-600 font-bold truncate uppercase" suppressHydrationWarning>
                        {effectiveRole}
                      </p>
                    </div>
                  </div>
          ...
          <div
            className={`flex-1 flex flex-col min-w-0 min-h-screen w-full pt-14 transition-all duration-200 ease-in-out ${
